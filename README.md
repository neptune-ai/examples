...
| | Neptune | GitHub
| :---: | :---: | :---:
| Text Classification | [![neptune]](https://app.neptune.ai/o/showcase/org/project-text-classification/experiments?split=tbl&dash=charts&viewId=standard-view) | [![github]](use-cases/nlp/classification)
