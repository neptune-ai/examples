...
- Once the migration and any sanity checks are complete, the copied Model/Model Versions can be deleted from the model registry and the "tmp_YYYYmmddHHMMSS" folder can be deleted from the working directory to reclaim space.
