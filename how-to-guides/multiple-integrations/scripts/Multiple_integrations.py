...
# https://docs-legacy.neptune.ai/integrations/airflow/
...
def objective(
    ...
    **context,
    ...
    with logger.get_run_from_context(context=context, log_context=True) as run:
        ...
        # Neptune+scikit-learn integration docs: https://docs-legacy.neptune.ai/integrations/sklearn/
...
def train_model_with_hpo(logger: NeptuneLogger, **context):
    ...
    with logger.get_task_handler_from_context(
        ...
        # Neptune+Optuna integration docs: https://docs-legacy.neptune.ai/integrations/optuna/
